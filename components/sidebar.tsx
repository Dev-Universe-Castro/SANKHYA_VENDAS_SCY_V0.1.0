...
import { Home, Users, ChevronLeft, ChevronRight, LogOut, UserCircle, LayoutGrid, Package, ShoppingCart, Calendar, DollarSign, RefreshCw } from "lucide-react"
...
export default function Sidebar({ isOpen, onClose, isCollapsed, onToggleCollapse }: SidebarProps) {
  ...
  const menuItems = [
    ...
    ...(currentUser?.role === "Administrador"
      ? [
          { href: "/dashboard/sincronizacao", label: "Sincronização Parceiros", icon: RefreshCw },
          { href: "/dashboard/sincronizacao-produtos", label: "Sincronização Produtos", icon: RefreshCw },
          { href: "/dashboard/sincronizacao-tipos-negociacao", label: "Sincronização Tipos Negociação", icon: RefreshCw },
          { href: "/dashboard/sincronizacao-tipos-operacao", label: "Sincronização Tipos Operação", icon: RefreshCw },
          { href: "/dashboard/sincronizacao-estoques", label: "Sincronização Estoques", icon: RefreshCw }
        ]
      : []),
  ]
